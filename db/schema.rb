...
ActiveRecord::Schema.define(version: 20170601142832) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "consent_forms", id: :serial, force: :cascade do |t|
    t.string "name"
    t.json "images"
  ...
  create_table "data_points", id: :serial, force: :cascade do |t|
    ...
    t.index ["session_id"], name: "index_data_points_on_session_id"
  end
  ...
  create_table "photos", id: :serial, force: :cascade do |t|
    ...
    t.string "ancestry"
    t.index ["ancestry"], name: "index_photos_on_ancestry"
    t.index ["photographable_id", "photographable_type"], name: "index_photos_on_photographable_id_and_photographable_type"
  end
  ...
  create_table "sessions", id: :serial, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "data_points_count", default: 0
    t.integer "consent_forms_count", default: 0
